...
module.exports.routes = {
  ...
  'GET /customer/:id': 'CustomerController.findOne',
  'POST /customer/:id': 'CustomerController.update',
  'DELETE /customer/:id': 'CustomerController.delete',
  'GET /customer/:id': 'CustomerProfileController.find',
  ...
  'POST /order/:id': 'OrderController.update',
  'POST /order/:id': 'OrderController.create',
  ...
  //SALE
  'POST /sale': 'SaleController.create',
  'GET /sale': 'SaleController.find',
  'POST /sale/:id': 'SaleController.update',

  //COOLER
  'POST /cooler': 'CoolerController.create',
  'GET /cooler': 'CoolerController.find',
  'DELETE /cooler/:id': 'CoolerController.delete',
